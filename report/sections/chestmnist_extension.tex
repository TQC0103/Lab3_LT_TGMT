...
\input{tables/chestmnist_problem_setup}
...
\input{tables/chestmnist_naive_results}
...
\input{tables/chestmnist_per_class_auc}
...
\input{tables/chestmnist_weighted_cv_results}
\input{tables/chestmnist_weighted_per_class}
...
\input{tables/chestmnist_lite_results}
...
\input{tables/chestmnist_ann_architecture_details}
\input{tables/chestmnist_ann_hyperparameters}
\input{tables/chestmnist_ann_iteration_logic}
\input{tables/chestmnist_model_comparison}
...
Kết luận cho Chương 3 là: với ChestMNIST, thành phần quyết định hiệu quả không chỉ là mở rộng MLP, mà là kết hợp đúng giữa weighted loss, cross-validation ensemble và feature engineering phù hợp với dữ liệu y sinh. Đây cũng là chương cho thấy rõ nhất giới hạn của raw pixel thuần và giá trị của việc thiết kế đầu vào có chủ đích cho ANN.
